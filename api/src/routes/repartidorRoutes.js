...
* /drivers/{id}/location:
*   put:
*     summary: Actualizar ubicación GPS de un repartidor
*     description: Actualiza las coordenadas GPS (latitud y longitud) de un repartidor específico. Solo administradores pueden realizar esta acción. También invalida los cachés relacionados con ubicaciones.
*     tags: [Repartidores]
*     security:
*       - bearerAuth: []
*     parameters:
...
*                 estado: "disponible"
*       400:
*         description: Error de validación - coordenadas inválidas o fuera de rango
*         content:
*           application/json:
*             schema:
*               $ref: '#/components/schemas/Error'
...
*       403:
*         description: No autorizado - solo administradores pueden actualizar ubicaciones
*         content:
*           application/json:
*             schema:
*               $ref: '#/components/schemas/Error'
...
*     description: Cambia el estado operativo de un repartidor (disponible, ocupado, desconectado). Solo administradores pueden realizar esta acción. También invalida los cachés relacionados.
*     tags: [Repartidores]
*     security:
*       - bearerAuth: []
*     parameters:
...
*               error: "Token requerido."
*       403:
*         description: No autorizado - solo administradores pueden cambiar estados
*         content:
*           application/json:
*             schema:
*               $ref: '#/components/schemas/Error'

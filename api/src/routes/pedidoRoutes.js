...
*     description: Actualiza uno o más campos de un pedido específico (estado, tipo y/o fecha_hora). Al menos uno de los campos debe ser proporcionado. Solo usuarios autenticados pueden realizar esta acción. Invalida múltiples cachés relacionados.
*     tags: [Pedidos]
*     security:
*       - bearerAuth: []
*     parameters:
...
*                 type: string
*                 enum: [en restaurante, para recoger]
*                 description: Tipo de pedido (opcional)
*                 example: "para recoger"
*               fecha_hora:
*                 type: string
*                 format: date-time
*                 description: Fecha y hora del pedido en formato ISO 8601 (opcional)
...
*                 estado: "listo"
*             solo_tipo:
*               summary: Actualizar solo el tipo
*               value:
*                 tipo: "para recoger"
*             solo_fecha:
...
*                   estadosValidos: ["pendiente", "en preparacion", "listo", "entregado"]
*               tipo_invalido:
*                 summary: Tipo no válido
*                 value:
*                   error: "Tipo inválido."
*                   tiposValidos: ["en restaurante", "para recoger"]
*               fecha_invalida:
...
*/
router.put('/:id', authMiddleware, pedidoController.updateDelivery);
